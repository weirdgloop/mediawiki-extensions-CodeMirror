...
// This file was generated by lezer-generator. You probably shouldn't edit it.
const spec_identifier$1 = {__proto__:null,export:20, as:25, from:33, default:36, async:41, function:42, in:52, out:55, const:56, extends:60, this:64, true:72, false:72, null:84, void:88, typeof:92, super:108, new:142, delete:154, yield:163, await:167, class:172, public:235, private:235, protected:235, readonly:237, instanceof:256, satisfies:259, import:292, keyof:349, unique:353, infer:359, asserts:395, is:397, abstract:417, implements:419, type:421, let:424, var:426, using:429, interface:435, enum:439, namespace:445, module:447, declare:451, global:455, defer:471, for:476, of:485, while:488, with:492, do:496, if:500, else:502, switch:506, case:512, try:518, catch:522, finally:526, return:530, throw:534, break:538, continue:542, debugger:546};
...
const parser$5 = LRParser.deserialize({
  ...
  specialized: [{term: 327, get: (value) => spec_identifier$1[value] || -1},{term: 343, get: (value) => spec_word[value] || -1},{term: 95, get: (value) => spec_LessThan[value] || -1}],
  tokenPrec: 15201
});
...
const identifiers = new ExternalTokenizer((input, stack) => {
  for (let inside = false, dashes = 0, i = 0;; i++) {
    let {next} = input;
    if (isAlpha$1(next) || next == dash$1 || next == underscore || (inside && isDigit$1(next))) {
...
const descendant$1 = new ExternalTokenizer(input => {
  if (space$1.includes(input.peek(-1))) {
    ...
    if (isAlpha$1(next) || next == underscore || next == hash || next == period ||
        next == asterisk || next == bracketL || next == colon && isAlpha$1(input.peek(1)) ||
...
const unitToken$1 = new ExternalTokenizer(input => {
  if (!space$1.includes(input.peek(-1))) {
    let {next} = input;
    if (next == percent) { input.advance(); input.acceptToken(Unit$1); }
    if (isAlpha$1(next)) {
      do { input.advance(); } while (isAlpha$1(input.next) || isDigit$1(input.next))
...
const spec_AtKeyword$1 = {__proto__:null,"@import":120, "@media":154, "@charset":158, "@namespace":162, "@keyframes":168, "@supports":180};
...
const parser$4 = LRParser.deserialize({
  ...
  tokenizers: [descendant$1, unitToken$1, identifiers, 1, 2, 3, 4, new LocalTokenGroup("m~RRYZ[z{a~~g~aO#g~~dP!P!Qg~lO#h~~", 28, 114)],
  topRules: {"StyleSheet":[0,4],"Styles":[1,92]},
  specialized: [{term: 108, get: (value) => spec_callee[value] || -1},{term: 59, get: (value) => spec_AtKeyword$1[value] || -1},{term: 110, get: (value) => spec_queryIdentifier[value] || -1}],
  tokenPrec: 1441
});
...
const lessHighlighting = /*@__PURE__*/ext_CodeMirror_lib.styleTags({
    "import charset namespace keyframes media supports when": ext_CodeMirror_lib.tags.definitionKeyword,
    "from to selector": ext_CodeMirror_lib.tags.keyword,
    NamespaceName: ext_CodeMirror_lib.tags.namespace,
    KeyframeName: ext_CodeMirror_lib.tags.labelName,
    TagName: ext_CodeMirror_lib.tags.tagName,
    ClassName: ext_CodeMirror_lib.tags.className,
    PseudoClassName: /*@__PURE__*/ext_CodeMirror_lib.tags.constant(ext_CodeMirror_lib.tags.className),
    IdName: ext_CodeMirror_lib.tags.labelName,
    "FeatureName PropertyName PropertyVariable": ext_CodeMirror_lib.tags.propertyName,
    AttributeName: ext_CodeMirror_lib.tags.attributeName,
    NumberLiteral: ext_CodeMirror_lib.tags.number,
    KeywordQuery: ext_CodeMirror_lib.tags.keyword,
    UnaryQueryOp: ext_CodeMirror_lib.tags.operatorKeyword,
    "CallTag ValueName": ext_CodeMirror_lib.tags.atom,
    VariableName: ext_CodeMirror_lib.tags.variableName,
    "AtKeyword Interpolation": /*@__PURE__*/ext_CodeMirror_lib.tags.special(ext_CodeMirror_lib.tags.variableName),
    Callee: ext_CodeMirror_lib.tags.operatorKeyword,
    Unit: ext_CodeMirror_lib.tags.unit,
    "UniversalSelector NestingSelector": ext_CodeMirror_lib.tags.definitionOperator,
    MatchOp: ext_CodeMirror_lib.tags.compareOperator,
    "ChildOp SiblingOp, LogicOp": ext_CodeMirror_lib.tags.logicOperator,
    BinOp: ext_CodeMirror_lib.tags.arithmeticOperator,
    Important: ext_CodeMirror_lib.tags.modifier,
    "Comment LineComment": ext_CodeMirror_lib.tags.blockComment,
    ColorLiteral: ext_CodeMirror_lib.tags.color,
    "ParenthesizedContent StringLiteral": ext_CodeMirror_lib.tags.string,
    Escape: /*@__PURE__*/ext_CodeMirror_lib.tags.special(ext_CodeMirror_lib.tags.string),
    ": ...": ext_CodeMirror_lib.tags.punctuation,
    "PseudoOp #": ext_CodeMirror_lib.tags.derefOperator,
    "; ,": ext_CodeMirror_lib.tags.separator,
    "( )": ext_CodeMirror_lib.tags.paren,
...
*/
const lessLanguage = /*@__PURE__*/ext_CodeMirror_lib.LRLanguage.define({
    name: "less",
    parser: /*@__PURE__*/parser$1.configure({
        props: [
            ...
            /*@__PURE__*/ext_CodeMirror_lib.foldNodeProp.add({
                Block: ext_CodeMirror_lib.foldInside
            })
        ]
    }),
    languageData: {
...
*/
function less() {
    return new ext_CodeMirror_lib.LanguageSupport(lessLanguage, lessLanguage.data.of({ autocomplete: lessCompletionSource }));
}
